...
class NetworkingHandle:
    @staticmethod
    def new(identity: builtins.str, namespace: builtins.str, listen_port: builtins.int, discovery_service_port: builtins.int, bootstrap_peers: list[builtins.str]) -> NetworkingHandle: ...
